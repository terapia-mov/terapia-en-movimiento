import { BLOCKS, MARKS, INLINES, helpers as helpers$1 } from '@contentful/rich-text-types';
export { BLOCKS, INLINES, MARKS } from '@contentful/rich-text-types';
...
var renderBlockListItem = function renderBlockListItem(_, _ref) {
  var next = _ref.next,
      parent = _ref.parent,
      index = _ref.index;
  var isOL = (parent == null ? void 0 : parent.nodeType) === BLOCKS.OL_LIST;
...
var _marks, _blocks;
var marks = (_marks = {}, _marks[MARKS.BOLD] = renderMarkBold, _marks[MARKS.ITALIC] = renderMarkItalic, _marks[MARKS.UNDERLINE] = renderMarkUnderline, _marks[MARKS.CODE] = renderMarkCode, _marks);
var blocks = (_blocks = {}, _blocks[BLOCKS.PARAGRAPH] = renderBlockParagraph, _blocks[BLOCKS.HEADING_1] = /*#__PURE__*/createRenderBlockHeading(1), _blocks[BLOCKS.HEADING_2] = /*#__PURE__*/createRenderBlockHeading(2), _blocks[BLOCKS.HEADING_3] = /*#__PURE__*/createRenderBlockHeading(3), _blocks[BLOCKS.HEADING_4] = /*#__PURE__*/createRenderBlockHeading(4), _blocks[BLOCKS.HEADING_5] = /*#__PURE__*/createRenderBlockHeading(5), _blocks[BLOCKS.HEADING_6] = /*#__PURE__*/createRenderBlockHeading(6), _blocks[BLOCKS.EMBEDDED_ENTRY] = renderBlockEmbeddedEntry, _blocks[BLOCKS.EMBEDDED_ASSET] = renderBlockEmbeddedAsset, _blocks[BLOCKS.UL_LIST] = renderBlockUseChild, _blocks[BLOCKS.OL_LIST] = renderBlockUseChild, _blocks[BLOCKS.LIST_ITEM] = renderBlockListItem, _blocks[BLOCKS.QUOTE] = renderBlockQuote, _blocks[BLOCKS.HR] = renderBlockHr, _blocks[INLINES.ASSET_HYPERLINK] = renderInlineAssetHyperlink, _blocks[INLINES.ENTRY_HYPERLINK] = renderInlineEntryHyperlink, _blocks[INLINES.EMBEDDED_ENTRY] = renderInlineEmbeddedEntry, _blocks[INLINES.HYPERLINK] = renderInlineHyperlink, _blocks.fallback = renderBlockFallback, _blocks);
...
export { asModelRender, documentToMarkdown, helpers, index as renders, validateEntry };
//# sourceMappingURL=contentful-rich-text-to-markdown.esm.js.map
